...
public class AppWidgetResizeFrame extends AbstractFloatingView implements View.OnKeyListener, DragController.DragListener {
    ...
    private void setupForWidget(View widgetView, CellLayout cellLayout,
                                DragLayer dragLayer) {
    ...
    public void visualizeResizeForDelta(int deltaX, int deltaY) {
        Log.d(TAG, "visualizeResizeForDelta deltaX=" + deltaX + " deltaY=" + deltaY);
    ...
    private void resizeWidgetIfNeeded(boolean onDismiss) {
        ...
        Log.d(TAG, "cellX=" + cellX + " cellY=" + cellY + " spanX=" + spanX + " spanY=" + spanY);
        if (mCellLayout.createAreaForResize(cellX, cellY, spanX, spanY, mWidgetView,
            ...
            lp.cellHSpan = spanX;
            lp.cellVSpan = spanY;
//            ItemInfo info = (ItemInfo) mWidgetView.getTag();
//            info.cellX = cellX;
//            info.cellY = cellY;
//            info.spanX = spanX;
//            info.spanY = spanY;
            ...
            if (!onDismiss) {
                updateWidgetSizeRanges(mWidgetView, getContext(), spanX, spanY);
            }
        }
        mWidgetView.requestLayout();
    }

    static void updateWidgetSizeRanges(View widgetView, Context context,
                                       int spanX, int spanY) {
        getWidgetSizeRanges(context, spanX, spanY, sTmpRect);
...
//        float scale = mWidgetView.getScaleToFit();
    ...
    private boolean handleTouchDown(MotionEvent ev) {
        ...
        getHitRect(hitRect);
        Log.d(TAG, "handleTouchDown contains=" + hitRect.contains(x, y));
    ...
    public boolean onControllerInterceptTouchEvent(MotionEvent ev) {
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            Log.d(TAG, "onControllerInterceptTouchEvent-->actionDown-->close");
            close(false);
        } else if (MotionEvent.ACTION_UP == ev.getAction() && !handleTouchDown(ev)) {
            Log.d(TAG, "onControllerInterceptTouchEvent-->actionUp-->close");
            close(false);
        }
        return false;
    }
    ...
    public void onDragEnd() {
        Log.d(TAG, "onDragEnd isOpen=" + mIsOpen);
//        if (mIsOpen) {
//            close(true);
//        }
    }
