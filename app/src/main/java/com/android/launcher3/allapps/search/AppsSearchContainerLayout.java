...
public class AppsSearchContainerLayout extends ExtendedEditText
        implements SearchUiManager, AllAppsSearchBarController.Callbacks, Insettable {

    private static final String TAG = "ASContainerLayout";
...
//        Log.d(TAG, "getPaddingLeft=" + mAppsView.getActiveRecyclerView().getPaddingLeft());
//        Log.d(TAG, "getPaddingRight=" + mAppsView.getActiveRecyclerView().getPaddingRight());
//        Log.d(TAG, "getPaddingLeft1=" + ((View)getParent()).getPaddingLeft());
//        Log.d(TAG, "getPaddingRight1=" + ((View)getParent()).getPaddingRight());
...
//        mApps = appsView.getApps();
        ...
        mSearchBarController.initialize(
                new DefaultAppSearchAlgorithm(), this, mLauncher, this);
    }
