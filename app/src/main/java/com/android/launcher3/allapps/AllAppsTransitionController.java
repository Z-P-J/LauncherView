...
public class AllAppsTransitionController implements StateHandler, OnDeviceProfileChangeListener {
    ...
    public void setProgress(float progress) {
        Log.d("setProgress", "setProgress progress=" + progress);
        mProgress = progress;
...
//        setter.setViewAlpha(mAppsView.getActiveRecyclerView(), hasContent ? 1 : 0, LINEAR);
...
//            mLauncher.getWorkspace().setTranslationY(0);
        } else {
            mAppsView.setVisibility(View.VISIBLE);
//            mLauncher.getWorkspace().setTranslationY(0);
        }
