...
//        }
    ...
    public boolean addViewToCellLayout(View child, int index, int childId, LayoutParams params,
        ...
        Log.d(TAG, "addViewToCellLayout mChildScale=" + mChildScale + " mContainerType=" + mContainerType);
        Log.d(TAG, "addViewToCellLayout params=" + params);
...
//        }
        ...
        public String toString() {
            return "LayoutParams{" +
                    ...
                    ", tmpCellX=" + tmpCellX +
                    ", tmpCellY=" + tmpCellY +
                    ", useTmpCoords=" + useTmpCoords +
                    ", cellHSpan=" + cellHSpan +
                    ", cellVSpan=" + cellVSpan +
                    ", isLockedToGrid=" + isLockedToGrid +
